...
public class Solution {
                                       ...
                                       HashMap<Integer,Integer> map)
    {
        ...
        int index = map.get(preorder[preL]); //the index of root.val in inorder array
...
public class Solution {
    ...
    private TreeNode buildTreeHelper(int[] preorder,int preL, int preR, int inL,HashMap<Integer,Integer> map)
    {
        if(preL>preR) return null;//base case
